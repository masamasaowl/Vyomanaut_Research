...
- [Milestone 12 — Coordination Microservice (`cmd/microservice`)](./build_part3.md#milestone-12--coordination-microservice-cmdmicroservice)
  - [Phase 12.1 — Microservice Startup](./build_part3.md#phase-121--microservice-startup)
- [Milestone M-OBS — Observability & Metrics](./build_part3.md#milestone-m-obs--observability--metrics)
  - [Phase OBS.1 — Microservice Metrics](./build_part3.md#phase-obs1--microservice-metrics)
  - [Phase OBS.2 — Provider Daemon Metrics](./build_part3.md#phase-obs2--provider-daemon-metrics)
  - [Phase OBS.3 — Operational Alerts](./build_part3.md#phase-obs3--operational-alerts)
  - [Phase OBS.4 — Prometheus Metric Naming CI Gate](./build_part3.md#phase-obs4--prometheus-metric-naming-ci-gate)
- [Milestone 13 — Provider Daemon Core (`cmd/provider`)](./build_part3.md#milestone-13--provider-daemon-core-cmdprovider)
  - [Phase 13.1 — Provider Startup](./build_part3.md#phase-131--provider-startup)
  - [Phase 13.2 — Chunk Upload Stream Handler](./build_part3.md#phase-132--chunk-upload-stream-handler)
  - [Phase 13.3 — Audit Challenge Stream Handler](./build_part3.md#phase-133--audit-challenge-stream-handler)
  - [Phase 13.4 — Repair Download Stream Handler](./build_part3.md#phase-134--repair-download-stream-handler)
  - [Phase 13.5 — Vetting GC Stream Handler](./build_part3.md#phase-135--vetting-gc-stream-handler)
  - [Phase 13.6 — Provider RAM Check at Installation](./build_part3.md#phase-136--provider-ram-check-at-installation)
- [Milestone 14 — Vetting & Synthetic Chunks (`internal/vettingchunk`)](./build_part3.md#milestone-14--vetting--synthetic-chunks-internalvettingchunk)
  - [Phase 14.1 — Synthetic Chunk Generator](./build_part3.md#phase-141--synthetic-chunk-generator)
  - [Phase 14.2 — GC Delivery](./build_part3.md#phase-142--gc-delivery)
